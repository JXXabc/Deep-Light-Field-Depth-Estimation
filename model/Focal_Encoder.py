...
###################################depth decoder block##################################
class VGG_Focal(nn.Module):
    def __init__(self, channel=32):
        super(VGG_Focal, self).__init__()
        self.vgg = B2_VGG()
        self.focal3_1 = CRU(256, channel,32*32)
        self.focal4_1 = CRU(512, channel,16*16)
        self.focal5_1 = CRU(512, channel,8*8)
    def forward(self, x):
        x1 = self.vgg.conv1(x)
        ...
        x3_1 = self.focal3_1(x3_1)
        x4_1 = self.focal4_1(x4_1)
        x5_1 = self.focal5_1(x5_1)
