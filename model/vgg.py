...
class B2_VGG(nn.Module):
    ...
    def __init__(self):
        ...
        conv4_3.add_module('pool3_3', nn.AvgPool2d(2, stride=2))
        conv4_3.add_module('conv4_1_3', nn.Conv2d(256, 512, 3, 1, 1))
        conv4_3.add_module('relu4_1_3', nn.ReLU())
        conv4_3.add_module('conv4_2_3', nn.Conv2d(512, 512, 3, 1, 1))
        conv4_3.add_module('relu4_2_3', nn.ReLU())
        conv4_3.add_module('conv4_3_3', nn.Conv2d(512, 512, 3, 1, 1))
        conv4_3.add_module('relu4_3_3', nn.ReLU())
        ...
        conv5_3 = nn.Sequential()
        conv5_3.add_module('pool4_3', nn.AvgPool2d(2, stride=2))
        conv5_3.add_module('conv5_1_3', nn.Conv2d(512, 512, 3, 1, 1))
        conv5_3.add_module('relu5_1_3', nn.ReLU())
        conv5_3.add_module('conv5_2_3', nn.Conv2d(512, 512, 3, 1, 1))
        conv5_3.add_module('relu5_2_3', nn.ReLU())
        conv5_3.add_module('conv5_3_3', nn.Conv2d(512, 512, 3, 1, 1))
        conv5_3.add_module('relu5_3_3', nn.ReLU())
        self.conv5_3 = conv5_3

        pre_train = torch.load('./model/VGG16.pth')
    ...
    def forward(self, x):
        ...
        x1 = self.conv5_1(x1)
        x2 = self.conv4_2(x)
        x2_1 = self.conv5_2(x2)
        x2_2 = self.conv5_3(x2)
        return x1, x2_1, x2_2
    ...
    def _initialize_weights(self, pre_train):
        ...
        ##
        self.conv4_3.conv4_1_3.weight.data.copy_(pre_train[keys[14]])
        self.conv4_3.conv4_2_3.weight.data.copy_(pre_train[keys[16]])
        self.conv4_3.conv4_3_3.weight.data.copy_(pre_train[keys[18]])
        self.conv5_3.conv5_1_3.weight.data.copy_(pre_train[keys[20]])
        self.conv5_3.conv5_2_3.weight.data.copy_(pre_train[keys[22]])
        self.conv5_3.conv5_3_3.weight.data.copy_(pre_train[keys[24]])
        ...
        ##
        self.conv4_3.conv4_1_3.bias.data.copy_(pre_train[keys[15]])
        self.conv4_3.conv4_2_3.bias.data.copy_(pre_train[keys[17]])
        self.conv4_3.conv4_3_3.bias.data.copy_(pre_train[keys[19]])
        self.conv5_3.conv5_1_3.bias.data.copy_(pre_train[keys[21]])
        self.conv5_3.conv5_2_3.bias.data.copy_(pre_train[keys[23]])
        self.conv5_3.conv5_3_3.bias.data.copy_(pre_train[keys[25]])
